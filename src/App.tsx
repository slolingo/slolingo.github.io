  ...
  <div className="flex justify-center mt-12">
    <button onClick={() => window.location.href = '/'} className="bg-slolingo-orange text-white font-apfel-medium px-8 py-3 rounded-full shadow-lg hover:bg-orange-500 transition-colors text-lg flex items-center gap-2">
      ...
      Zurück zur Startseite
          ...
          <Route path="/agb" element={<div className="pt-20 px-4 py-8 max-w-2xl mx-auto"><h1 className="text-4xl font-apfel-medium text-slolingo-primaryText mb-8">{t('terms.title')}</h1><div className="text-body space-y-8" dangerouslySetInnerHTML={{ __html: t('terms.body.html') }}></div></div>} />
        </Routes>
        <Footer />
      </div>
    </Router>
